        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-default">
                <form id="imgprofile" action="<?php echo base_url('/imgprofile');?>" name="ajax_form" id="ajax_form" method="post" accept-charset="utf-8" enctype="multipart/form-data">

              <div class="card-header">
                <h3 class="card-title">Silahkan Upload Foto Profile Anda <small><em>Keamanan</em> Anda Kami Jamin :)</small></h3>
              </div>
              <div class="card-body">
                <div id="actionspp" class="row">
                  <div class="col-lg-6">
                    <div class="btn-group w-100">
                      <span onclick="startdropzonepp()" class="btn btn-success col fileinput-buttonpp">
                        <i class="fas fa-plus"></i>
                        <span>Add files</span>
                      </span>
                      <button type="button" class="btn btn-primary col startpp">
                        <i class="fas fa-upload"></i>
                        <span>Start upload</span>
                      </button>
                      <button type="reset" class="btn btn-warning col cancelpp">
                  ...
                  <div class="col-lg-6 d-flex align-items-center">
                    <div class="fileupload-process w-100">
                      <div id="total-progresspp" class="progress progress-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">
                        <div class="progress-barpp progress-bar-success" style="width:0%;" data-dz-uploadprogress></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="table table-striped files" id="previewspp">
                  <div id="templatepp" class="row mt-2">
                    <div class="col-auto">
                    ...
                    <div class="col-auto d-flex align-items-center">
                      <div class="btn-group">
                        <button class="btn btn-primary startpp">
                          <i class="fas fa-upload"></i>
                          <span>Start</span>
                        </button>
                        <button data-dz-remove class="btn btn-warning cancelpp">
                          <i class="fas fa-times-circle"></i>
                          <span>Cancel</span>
                        </button>
                        <button data-dz-remove class="btn btn-danger deletepp">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-default">
              ...
              <div class="card-header">
                <h3 class="card-title">Silahkan Upload KTP Anda <small><em>Keamanan Data</em> Anda Kami Jamin :)</small></h3>
              </div>
              <div class="card-body">
                <div id="actionsktp" class="row">
                  <div class="col-lg-6">
                    <div class="btn-group w-100">
                      <span onclick="startdropzonektp()" class="btn btn-success col fileinput-buttonktp">
                        <i class="fas fa-plus"></i>
                        <span>Add files</span>
                      </span>
                      <button type="button" class="btn btn-primary col startktp">
                        <i class="fas fa-upload"></i>
                        <span>Start upload</span>
                      </button>
                      <button type="reset" class="btn btn-warning col cancelktp">
                        <i class="fas fa-times-circle"></i>
                        <span>Cancel upload</span>
                      </button>
                    </div>
                  ...
                  <div class="col-lg-6 d-flex align-items-center">
                    <div class="fileupload-processktp w-100">
                      <div id="total-progressktp" class="progress progress-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">
                        <div class="progress-barktp progress-bar-success" style="width:0%;" data-dz-uploadprogress></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="table table-striped files" id="previewsktp">
                  <div id="templatektp" class="row mt-2">
                    <div class="col-auto">
                        <span class="preview"><img src="data:," alt="" data-dz-thumbnail /></span>
                    </div>
                    <div class="col d-flex align-items-center">
                    ...
                    <div class="col-auto d-flex align-items-center">
                      <div class="btn-group">
                        <button class="btn btn-primary startktp">
                          <i class="fas fa-upload"></i>
                          <span>Start</span>
                        </button>
                        <button data-dz-remove class="btn btn-warning cancelktp">
                          <i class="fas fa-times-circle"></i>
                          <span>Cancel</span>
                        </button>
                        <button data-dz-remove class="btn btn-danger deletektp">
                          <i class="fas fa-trash"></i>
                          <span>Delete</span>
                        </button>
                      </div>
